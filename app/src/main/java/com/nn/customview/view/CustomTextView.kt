...
/**
 *  Automatically generate this file after new a custom view including an attribute file named
 */
class CustomTextView : TextView {
    ...
    private fun init(attrs: AttributeSet?, defStyle: Int) {
        ...
        mExampleString = a.getString(
                R.styleable.CustomTextView_exampleString)
        mExampleColor = a.getColor(
                R.styleable.CustomTextView_exampleColor,
                mExampleColor)
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.CustomTextView_exampleDimension,
                mExampleDimension)

        if (a.hasValue(R.styleable.CustomTextView_exampleDrawable)) {
            exampleDrawable = a.getDrawable(
                    R.styleable.CustomTextView_exampleDrawable)
